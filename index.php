...
<div class="d-flex flex-wrap gap-2 mb-4">
    ...
    <button class="btn fw-bold shadow-sm btn-hub-toggle position-relative"
            style="border:2px solid #dc3545;color:#dc3545;background:#fff;"
            onclick="hubToggle('painelRenovacao', this)">
        <i class="fas fa-sync-alt me-2"></i> RENOVAÇÃO
        <?php if ($renov_stats['em_aberto'] > 0): ?>
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size:.55rem;min-width:18px;"><?= $renov_stats['em_aberto'] ?></span>
        <?php endif; ?>
    </button>
    <?php endif; ?>
