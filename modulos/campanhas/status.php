...
try {
    ...
    $stmtCamp = $pdo->query("SELECT c.ID, c.NOME_CAMPANHA, c.CNPJ_EMPRESA, e.NOME_CADASTRO as NOME_EMPRESA FROM BANCO_DE_DADOS_CAMPANHA_CAMPANHAS c LEFT JOIN CLIENTE_EMPRESAS e ON c.CNPJ_EMPRESA = e.CNPJ ORDER BY e.NOME_CADASTRO ASC, c.NOME_CAMPANHA ASC");
