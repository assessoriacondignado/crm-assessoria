    ...
    <div class="modal-dialog modal-lg">
        <form method="POST" class="modal-content border-dark shadow-lg">
            ...
            <div class="modal-body bg-light row g-3">
                ...
                <div class="col-md-6 mt-3"><label class="fw-bold small mb-1 text-danger">Ambiente de Uso <small class="text-muted fw-normal">(onde aparece)</small></label><select name="tipo_contato" id="form_tipo_status" class="form-select border-danger fw-bold" required><option value="CAMPANHA">📣 Campanha (modo campanha)</option><option value="FICHA_REGISTRO">📋 Ficha Registro (ficha do cliente)</option></select></div>
