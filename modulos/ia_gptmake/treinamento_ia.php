...
<p>PASSO 8 - FINALIZACAO: Apos a API retornar a resposta do ENVIAR_PROPOSTA, siga EXATAMENTE esta ordem sem desviar: PRIMEIRO envie EXATAMENTE esta mensagem "obg pela informação do pix, estarei digitando seu contrato, logo irei enviar o link para formalização e pagamento". SEGUNDO, envie IMEDIATAMENTE o link [link_assinatura] em seguida. NAO pergunte se o cliente quer o link. NAO aguarde confirmacao. NAO pergunte "deseja que eu envie agora?". Envie o link diretamente e imediatamente apos a mensagem de confirmacao. SE a API nao retornar o link, informe que o contrato foi registrado e um atendente enviará o link em breve.</p>
