                        ...
                        <div class="card-body bg-light">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="cpf_novo" class="form-control border-dark rounded-0" value="<?= $cpf_limpo_sugerido ?>" required maxlength="14">
                                </div>
                                <div class="col-md-6">
